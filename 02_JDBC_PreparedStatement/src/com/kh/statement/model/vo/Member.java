 ...
 * 해당 필드를 제외한 나머지 필드값을 초기화할 수 있는 생성자를 추가로 구성해둘 것
 */
public class Member {

	private int userNo; // USERNO MEMBER PRIMARY KEY,
	private String userId; // USERID VARHCAR2(15) UNIQUE NOT NULL
	...
	// 기본값이 존재하는 컬럼을 제외하고 나머지 필득밧만 초기화 해주는 생성자 추가
